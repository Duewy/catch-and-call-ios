...
final class TournamentVoiceHandler{
    ...
    private let measurementMode: MeasurementMode = .lbsOz       //TODO: Temperary for now
    ...
    func startPrompt() -> String {
        ...
        case .lbsOz:
            return "Please say the pounds, ounces, species, and clip color of your catch. Over."
        case .pounds:
            return "Please say the point pounds, species, and clip color of your catch. Over."
        case .kilograms:
            return "Please say the kilograms, grams, species, and clip color of your catch. Over."
        case .inches:
            return "Please say the inches, quarters, species, and clip color of your catch. Over."
        case .centimeters:
            return "Please say the centimeters, species, and clip color of your catch. Over."
        }
    }
    ...
    private func listenForCatch() {
        ...
        coordinator.startListening { [weak self]  (transcript: String) in
    ...
    func confirmPrompt(for p: ParsedCatch) -> String {
        switch measurementMode {
        case .lbsOz:
            return "To confirm, your \(p.species) is \(p.weightLbs) pounds and \(p.weightOz) ounces on the \(p.clipColor) clip. Is that correct?"
        case .pounds:
            return "To confirm, your \(p.species) is \(p.weightPounds) point \(p.weightDec) pounds on the \(p.clipColor) clip. Is that correct?"
        case .kilograms:
            return "To confirm, your \(p.species) is \(p.weightKgWhole) point \(p.weightGrams) kilograms on the \(p.clipColor) clip. Is that correct?"
        case .inches:
            return "To confirm, your \(p.species) is \(p.lengthInches) inches and \(p.lengthQuarters) quarters on the \(p.clipColor) clip. Is that correct?"
        case .centimeters:
            return "To confirm, your \(p.species) is \(p.lengthCm) point \(p.lengthTenths) centimeters on the \(p.clipColor) clip. Is that correct?"
        }
    }
    ...
    private func listenForConfirmation() {
        ...
        coordinator.startListening {[weak self]  (response: String) in
            guard let self else { return }
